"""
Django settings for offline_retail_stor_46823 project.
...
ROOT_URLCONF = 'offline_retail_stor_46823.urls'
...
WSGI_APPLICATION = 'offline_retail_stor_46823.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "offline_retail_stor_46823 API",
    "DESCRIPTION": "API documentation for offline_retail_stor_46823 App",
    "VERSION": "v1",
}
